namespace Domain.Models
{
    ...
    public class Transp
    {
        ...
        public int retTransp_vServ { get; set; }
        public int retTransp_vBCRet { get; set; }
        public int retTransp_pICMSRet { get; set; }
        public int retTransp_vICMSRet { get; set; }
        public int retTransp_CFOP { get; set; }
        public int retTransp_cMunFG { get; set; }
    ...
    public class Icms
    {
        ...
        public float pRedBCST { get; set; }
        public object pRedBC { get; set; }
        public float vBCST { get; set; }
        public float pICMSST { get; set; }
        public float vICMSST { get; set; }
